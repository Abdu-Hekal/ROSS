...
Generate Table 1 by averaging ROSS postprocessor results across multiple seeds using the existing eval_ood script.
"""
import os
import subprocess
import pandas as pd
...
# Save to CSV
out_path = os.path.join(tables_dir, "table1.csv")
