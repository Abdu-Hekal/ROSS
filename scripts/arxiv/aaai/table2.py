...
Generate Table 2: robustness of CIFAR-10 OOD detection under PGD-min and PGD-max attacks.
Runs eval_ood for no attack and attack_ood for attacks, averages over seeds.
Outputs CSV to scripts/ross/tables/table2.csv
"""
import os
import shutil
import subprocess
...
print(f"Saved Table 2 CSV to {out_path}") 