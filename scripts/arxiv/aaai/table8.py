...
Generate Table 8: analyze ROSS-fDBD post-processor on ImageNet200 with different lambda values.
...
EXP_ROOT = "./results/imagenet200_resnet18_32x32_base_e100_lr0.1_default"
...
# Save to CSV
out_path = os.path.join(tables_dir, 'table8.csv')
table.to_csv(out_path, index_label='lambda')
print(table)
print(f"Saved Table 8 CSV to {out_path}") 